...
foreach ($b in $branches) {
    ...
    git checkout calculation_app -- data/services.js components/service-header/index.js pages/service/index.js components/service-details/index.js pages/main/index.js utils/text-and-array-calculations.js
    ...
    if ($changes) {
        git commit -m "Sync: minimal header, sum_unique helper and services data"
    } else {
