function get_fields_html(calculation_type) {
    if (calculation_type === "factorial") {
        return `
            <div class="col-md-6">
                ...
                <input type="number" min="0" class="form-control" id="service-n" value="5" required>
            </div>
        `;
    }
    ...
    if (calculation_type === "gcd") {
        return `
            <div class="col-md-6">
                ...
                <input type="number" class="form-control" id="service-a" value="24" required>
            </div>
            <div class="col-md-6">
                <label class="form-label">Число b</label>
                <input type="number" class="form-control" id="service-b" value="18" required>
            </div>
        `;
    }
    ...
    if (calculation_type === "solve_expression") {
        return `
            <div class="col-md-8">
                ...
                <input type="text" class="form-control" id="service-expression" value="2*x+5" required>
            </div>
            <div class="col-md-4">
                <label class="form-label">Значение x</label>
                <input type="number" class="form-control" id="service-x" value="3" required>
            </div>
        `;
    }
    ...
    return `
        <div class="col-12">
            ...
            <input type="text" class="form-control" id="service-numbers" value="1, 2, 3, 4" required>
        </div>
    `;
}

export function service_request_form_html(service) {
    return `
        <form id="service-request-form" class="service-request-form-block">
